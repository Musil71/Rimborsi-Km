...
import { Users, Map, BarChart3, Route, Plus, ArrowRight, UserPlus } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      {state.people.length === 0 ? (
        <div className="rounded-xl border-2 border-dashed border-blue-200 bg-blue-50 px-8 py-10 text-center">
          ...
          <h3 className="text-lg font-semibold text-gray-800 mb-2">Nessuna persona ancora registrata</h3>
          <p className="text-gray-500 text-sm mb-5 max-w-sm mx-auto">
            Per iniziare a registrare trasferte devi prima aggiungere almeno una persona con il suo veicolo.
          </p>
          <Link
            to="/persone/nuovo"
